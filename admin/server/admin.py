...
PORT = 5001
# Read API_SERVER_URL from environment or use default
...
def proxy_recognize():
    """Proxy recognition requests to the backend API server."""
    try:
...
def admin_page():
    # Try to serve index.html first (standard React build), then admin.html
